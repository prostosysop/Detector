...
#  heatmap_name_only = heatmap_name.split('.')[0]
  image_name = os.path.join(settings.BASE_DIR, 'uploaded_images', 'static', heatmap_name)
...
#            if settings.DEBUG:
#                with open(os.path.join(settings.BASE_DIR, 'uploaded_videos', saved_video_file), 'wb') as vFile:
#                    shutil.copyfileobj(video_file, vFile)
#                request.session['file_name'] = os.path.join(settings.BASE_DIR, 'uploaded_videos', saved_video_file)
#            else:
            with open(os.path.join(settings.BASE_DIR, 'uploaded_videos', 'static', saved_video_file), 'wb') as vFile:
                shutil.copyfileobj(video_file, vFile)
            request.session['file_name'] = os.path.join(settings.BASE_DIR, 'uploaded_videos', 'static', saved_video_file)
...
#            image_path = "/home/prod/app/uploaded_images/static/" + image_name
#            image_path = image_name
            image_path = os.path.join(settings.BASE_DIR, 'uploaded_images', 'static', image_name)
            img.save(image_path)
...
#            if settings.DEBUG:
#                image_path = os.path.join(settings.BASE_DIR, 'uploaded_images', video_file_name_only+"_cropped_faces_"+str(i)+'.png')
#            else:
            image_path = os.path.join(settings.BASE_DIR, 'uploaded_images', 'static', video_file_name_only+"_cropped_faces_"+str(i)+'.png')
#            image_path = '/home/prod/app/uploaded_images/static/' + image_name
            img.save(image_path)
